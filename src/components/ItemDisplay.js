        ...
        <>
            <div className="item-vitrine">
                <div className='carrousel-watch-display'>
                    <img id='left' data-handle={watch.id} onClick={getPrevious} className='arrow left filter-img' src={process.env.PUBLIC_URL + '/svg/arrow-button-left-2-svgrepo-com.svg'} alt='arrow-navigation'></img>
                    ...
                    <img className='arrow right filter-img' src={process.env.PUBLIC_URL + '/svg/arrow-button-right-2-svgrepo-com.svg'} id='right' data-handle={watch.id} onClick={getNext} alt='arrow-navigation'></img>
                </div>
            </div>
